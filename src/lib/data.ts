  ...
  if (heroes.length === 0) {
    const initialHeroes: Omit<Hero, "id" | "created_at" | "updated_at">[] = [
      ...
      },
      {
        ...
        description:
          "Сүүлийн үеийн техник технологиор таны төслийг хэрэгжүүлнэ",
        image: "/api/placeholder/1920/1080",
        order_num: 2,
        active: true,
      },
      {
        ...
        description:
          "Чанартай гүйцэтгэл, таны итгэл найдварыг хүлээн зөвшөөрнө",
        image: "/api/placeholder/1920/1080",
        order_num: 3,
        active: true,
      },
  ...
  if (existingFAQs.length === 0) {
    const sampleFAQs: Omit<FAQ, "id" | "created_at" | "updated_at">[] = [
      // General FAQs
      {
        ...
        answer:
          "Манай компани 2014 оноос хойш Монгол Улсын барилгын салбарт тэргүүлэх байр суурь эзэлж, 10 жилийн туршлагатай бөгөөд 120 гаруй амжилттай төслийг хэрэгжүүлсэн байна.",
        order_num: 0,
        active: true,
      },
      {
        ...
        answer:
          "Бид орон сууц, оффис, үйлдвэрийн барилга, логистикийн төв, бизнес төв зэрэг бүх төрлийн барилгын ажлыг хийдэг. Мөн интерьер дизайн, инженерийн шийдэл зэрэг нэмэлт үйлчилгээ үзүүлдэг.",
        order_num: 1,
        active: true,
      },
      {
        ...
        answer:
          "Бид зөвхөн олон улсын стандартын чанартай, бат бөх, экологийн хувьд аюулгүй материалыг ашигладаг. Хамгийн сүүлийн үеийн барилгын материал, технологийг нэвтрүүлдэг.",
        order_num: 2,
        active: true,
      },
      {
        ...
        answer:
          "Бид бүх барилгад 2-10 жилийн баталгаат хугацаа олгодог. Мөн ашиглалтын үеийн үйлчилгээ, засвар үйлчилгээ үзүүлдэг.",
        order_num: 3,
        active: true,
      },
      ...
      // Project FAQs
      {
        ...
        answer:
          "Төслийн хэмжээ, нарийвчлалаас хамаарч 6 сараас 2 хүртэлх хугацаанд дуусдаг. Төсөл эхлэхээс өмнө нарийвчилсан хуваарь, төлөвлөгөө төвлөрүүлдэг.",
        order_num: 0,
        active: true,
      },
      {
        ...
        answer:
          "Төслийн өртгийг хэмжээ, материал, ажлын хүндрэл, хугацаа зэрэг олон хүчин зүйлс дээр суурилан нарийвчилж тооцдог. Үнэгүй зөвлөгөө, үнийн санал олгодог.",
        order_num: 1,
        active: true,
      },
      {
        ...
        answer:
          "Гэрээ байгуулахаас өмнө та өөрийн хүсэлтээр татгалзах боломжтой. Гэрээ байгуулсны дараа талуудын харилцан тохиролцоогоор татгалзах боломжтой.",
        order_num: 2,
        active: true,
      },
      {
        ...
        answer:
          "Бид төслийн явцыг 7 хоног тутамд зураг, тайлбартайгаар мэдэгддэг. Мөн шууд холбогдох боломж, онлайн хянах системтэй.",
        order_num: 3,
        active: true,
      },
      ...
      // Technical FAQs
      {
        ...
        answer:
          "Бид AutoCAD, Revit, SketchUp, 3D Max зэрэг сүүлийн үеийн програм хангамж ашиглан нарийвчилсан зураг төсөл хийдэг. 3D загвар, визуалчлал хийдэг.",
        order_num: 0,
        active: true,
      },
      {
        ...
        answer:
          "Тиймээ! Бид Монгол Улсын барилгын стандарт (MNS), олон улсын стандарт (ISO) бүгдийг хангадаг. Батлан хамгаалалтын шаардлагыг мөн хангадаг.",
        order_num: 1,
        active: true,
      },
      {
        ...
        answer:
          "Тиймээ! Бид эрчим хүчний хэмнэлттэй, ногоон барилгын технологи ашигладаг. Нарны цахилгаан, дулааны насос, хаалгагч систем суулгадаг.",
        order_num: 2,
        active: true,
      },
      {
        ...
        answer:
          "Бид аюулгүй байдлыг тэргүүлэх чухал зүйл гэж үздэг. Бүх ажилчид мэргэжлийн сургалттай, аюулгүй байдлын хэрэгсэлтэй, дахин сайжруулалт хийдэг.",
        order_num: 3,
        active: true,
      },
    ];
